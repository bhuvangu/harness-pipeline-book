...
For more details, go to [Verify Deployments with the Verify Step](/docs/continuous-delivery/verify/verify-deployments-with-the-verify-step/).
...
* [CD tutorials](/docs/continuous-delivery/get-started/tutorials/cd-gitops-tutorials)
* [CD overview and key concepts](/docs/continuous-delivery/overview)
* [Service-based licensing and usage for CD](/docs/continuous-delivery/cd-onboarding/service-licensing-for-cd)
