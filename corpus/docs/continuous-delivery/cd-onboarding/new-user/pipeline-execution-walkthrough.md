...
redirect_from:
  ...
  - /docs/continuous-delivery/cd-onboarding/pipeline-execution-walkthrough
  - /docs/continuous-delivery/cd-onboarding/new-user/pipeline-execution-walkthrough
---
...
For more information on creating CD pipelines, go to [CD tutorials](/docs/continuous-delivery/get-started/tutorials/cd-gitops-tutorials.
