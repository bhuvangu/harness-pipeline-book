...
Harness CD pipelines help you to orchestrate and automate your [Google Cloud Function deployments](https://developer.harness.io/docs/continuous-delivery/get-started/tutorials/google-cloud-deployments/gcp-cloud-func) and push updated functions to Google Cloud.
