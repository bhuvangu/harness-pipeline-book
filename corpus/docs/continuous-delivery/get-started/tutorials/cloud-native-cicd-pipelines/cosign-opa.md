...
- [Generate and verify SLSA Provenance](/docs/software-supply-chain-assurance/artifact-security/slsa/generate-slsa) using the Harness SCS steps in Harness CI/CD pipelines.
