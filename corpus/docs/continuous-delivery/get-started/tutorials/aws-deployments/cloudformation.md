...
redirect_from:
  ...
  - /docs/continuous-delivery/get-started/tutorials/cloudformation
---
...
4. A functioning **Harness pipeline** that deploys an application on your cluster using a manifest. Please follow this [get started tutorial](/docs/continuous-delivery/get-started/tutorials/kubernetes-container-deployments/manifest) to set it up.
