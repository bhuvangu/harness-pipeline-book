...
1. Make sure you have followed the [get started with CD tutorial](/docs/continuous-delivery/get-started/tutorials/kubernetes-container-deployments/manifest) and have the `guestbook` deployment pipeline up and running.
